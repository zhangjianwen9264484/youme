...
<li><a href="index.php">首页</a></li><li><a href="list.php?class='大生活'" title="感悟生活点滴">大生活</a></li><li><a href="shadow.php?class='光影斑斓'" title="光与影的艺术">光影斑斓</a></li><li><a href="ifture?class='如是观'" title="一切有为法，如梦幻泡影，如露亦如电，应作如是观。">如是观</a></li><li><a href="http://www.youmew.com/t/" target="_blank" title="还是以前的圈圈微博！">圈圈说</a></li><li><a href="http://www.youmew.com/guestbook.html" title="沟通从这里开始">留言本</a></li>
		...
		发布:圈圈 | 分类:".$value['class']." | 评论:".$sum." | 浏览:".$views."";
		echo "<script type='text/javascript'>LoadViewCount(77)</script> | <a href='article.php?id=".$value['id']."'>阅读全文 > </a>
		</h6>";
		echo "</div>";
		}
		?>
    <div class="post pagebar"><a href="ifture.php?page=<?php if(@$_GET['page']==''){echo '1';}else{if(@$_GET['page'] <= 1){echo '1';}else{echo $_GET['page']-1;}} ?>"><span class="page first-page">&laquo;</span></a>
      <?php
        for ($i=1; $i < $pageall+1; $i++) {
          echo "<a href='ifture.php?page=".$i."'><span class='page'>".$i."</span></a>";
        }
       ?>
      <a href='ifture.php?page=<?php if(@$_GET['page']==''){echo $pageall;}else{if(@$_GET['page']>=$pageall){echo $pageall;}else{echo @$_GET['page']+1;}} ?>'><span class="page last-page">&raquo;</span></a></div>
    		</div>
		<div id="divSidebar">
